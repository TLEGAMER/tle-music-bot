...
async def play(interaction: discord.Interaction, query: str):
    ...
    try:
        # เปลี่ยน stream=True เป็น stream=False เพื่อดาวน์โหลดไฟล์ก่อนเล่น
...
# 🔒 เปลี่ยน TOKEN จริงที่หลุดเป็น <YOUR_TOKEN_HERE>
bot.run("MTM3NTc3MTk5MzcxODM5NDkxMA.GfmZG8.XLIxcgjgq8wFMVJPvrjYKUMxhDK7agJhfhGk4U")
